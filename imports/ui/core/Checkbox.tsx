...
const CheckboxContainer = ({ disabled, ...rest }: CheckboxContainerProps) => (
...
const IndeterminateIcon = ({ size }: { size?: CheckboxSize }) => (
    ...
    <Flex direction={direction} gap={spacing} {...props}>
      {React.Children.map(children, (child) => {
        ...
        return React.cloneElement(child, {
          checked: (value || []).includes(child.props.value as string),
          onChange: handleChange,
        });
      })}
    </Flex>
