...
const Terms = () => (
  <div>
    ...
    <p>
      ...
      {publicSettings.name}. These discussions are kept for the duration of the process and will be
    ...
    <p>
      ...
      it. Your connection to {publicSettings.name} is also encrypted using SSL (HTTPS).
    </p>
    <p>
