...
function TermsForHost({ currentHost }) {
  ...
  return (
    <Box className="text-content" mb="24">
      ...
      <p>
        {entities} collects only two pieces of information: a username and an e-mail address. Your
      ...
      <p>
        We use your e-mail address to send you notifications. {entities} collects this information
        when you sign up for an account, as well as when you change your account information. To
        login you will be asked to provide a password for your account. It is your responsibility to
        ensure this password is stored securely and is sufficiently robust.
      </p>
      ...
      <p>
        {entities} uses cookies in your web browser for the sole purpose of storing your password.
        Your password is encrypted in our database, so there is no way we can access or read it.
        Your connection to {entities} is also encrypted using SSL (HTTPS).
      </p>
      <p>
      ...
      <p>
        You can contact {entities} via e-mail to request anything about your personal
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Emin Durak, Gokbel mah. Bozegri sk. 8/1 Ortaca, Mugla.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to this website by {entities}, accessible from{' '}
            <a href={currentHost.host} rel="external nofollow noopener" target="_blank">
              {currentHost.host}
            </a>
          </p>
        </li>
      ...
      <ul>
        <li>
          By emailing us:
          <a href={`mailto:${currentHost.settings.email}`}> {currentHost.settings.email}</a>
        </li>
      </ul>
    </Box>
  );
