...
const fancyDateStyle: React.CSSProperties = {
  alignItems: 'flex-end',
  display: 'flex',
...
const fancyTimeStyle: React.CSSProperties = {
  fontSize: 14,
  paddingTop: 6,
  fontStyle: 'italic',
};

export interface DateJustProps extends React.HTMLAttributes<HTMLDivElement> {
  time?: string | null;
  children?: any;
}

export function DateJust({ time, children, ...otherProps }: DateJustProps) {
  return (
    <div {...otherProps}>
...
export interface FancyDateProps extends React.ComponentProps<typeof Flex> {
