  ...
  return (
    <Box className="text-content" mb="24">
      ...
      <p>
        ...
        happening at {entities}, and can sign yourself up (RSVP) for events with
        a simple click. Your username will be visible for staff members in the
        list of attendees.
      </p>
      <p>
        The discussions for each study group are visible to all members of{' '}
        {entities}. These discussions are kept for the duration of the group and
      ...
      <p>
        ...
        You can easily delete your membership anytime you want.
      </p>
      <p>
      ...
      <p>
        {entities} collects only two pieces of information: a username and an
      ...
      <p>
        {entities} uses cookies in your web browser for the sole purpose of
        storing your password. Your password is encrypted in our database, so
        there is no way we can access or read it. Your connection to {entities}{' '}
      ...
      <p>
        We will never share or leave any of your personal information with any
      ...
      <p>
        You can contact {entities} via e-mail to request anything about your
      ...
      <p>
        You can delete your account at any time, which will delete all personal
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Emin Durak, Gokbel mah.
            Bozegri sk. 8/1 Ortaca, Mugla.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            who groups the data on behalf of the Company. It refers to
      ...
      <p>
        Your information, including Personal Data, is grouped at the Company's
        operating offices and in any other places where the parties involved in
        the grouping are located. It means that this information may be
