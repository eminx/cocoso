...
Hosts.schema = new SimpleSchema({
  ...
  'style.body': { type: Object, optional: true },
  'style.body.backgroundColor': { type: String, optional: true },
  'style.body.backgroundImage': { type: String, optional: true },
  'style.body.backgroundRepeat': { type: String, optional: true },
  'style.body.font': { type: String, optional: true },
  'style.buttons': { type: Object, optional: true },
  'style.buttons.borderRadius': { type: String, optional: true },
  'style.buttons.borderColor': { type: String, optional: true },
  'style.buttons.backgroundColor': { type: String, optional: true },
  'style.buttons.color': { type: String, optional: true },
  'style.titles': { type: Object, optional: true },
  'style.titles.fontStyle': { type: String, optional: true },
  'style.titles.textTransform': { type: String, optional: true },
  'style.titles.fontWeight': { type: String, optional: true },
  'style.inputs': { type: Object, optional: true },
  'style.inputs.borderRadius': { type: String, optional: true },
  'style.inputs.backgroundColor': { type: String, optional: true },
  'style.inputs.color': { type: String, optional: true },
