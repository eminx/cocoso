...
Hosts.schema = new SimpleSchema({
  ...
  'style.body.fontFamily': { type: String, optional: true },
  'style.menu': { type: Object, optional: true },
  'style.menu.backgroundColor': { type: String, optional: true },
  'style.menu.borderColor': { type: String, optional: true },
  'style.menu.borderRadius': { type: String, optional: true },
  'style.menu.borderStyle': { type: String, optional: true },
  'style.menu.borderWidth': { type: String, optional: true },
  ...
  'style.theme': { type: Object, optional: true },
  'style.theme.backgroundColor': { type: String, optional: true },
  'style.theme.borderRadius': { type: String, optional: true },
  'style.theme.hue': { type: String, optional: true },
  'style.theme.variant': { type: String, optional: true },
