export default {
  ...
  sv: {
    ...
    activityRegister: {
      ...
      confirmedApprovalTextLong:
        'Kan du föredra att göra ändringar i din registrering eller avbryta den; vänligen gå till aktivitetssidan, öppna datumet du registrerade dig för och klicka sedan på länken "Ändra/avbryt befintlig registrering". Följ sedan instruktionerna där för att uppdatera dina uppgifter eller helt avbryta din registrering för detta evenemang.',
