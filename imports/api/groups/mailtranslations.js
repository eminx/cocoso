export default {
  en: {
    ...
    invitePrivateGroup: {
      confirmedApprovalText: 'This is an email to invite you to a private group',
      confirmedApprovalTextLong:
  ...
  sv: {
    ...
    attendMeeting: {
      ...
      confirmedApprovalTextLong:
        'Du är välkommen att följa uppdateringar, registrera dig till kommande möten och delta i diskussionerna på gruppens/groupens sida.',
    },
    unattendMeeting: {
      confirmedApprovalText: 'Du har tagit bort din registering till mötet',
      confirmedApprovalTextLong:
        'Du är välkommen att följa uppdateringar, registrera dig till kommande möten och delta i diskussionerna på gruppens/groupens sida.',
    },
  },
