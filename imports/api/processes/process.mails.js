...
const getProcessJoinText = (firstName, processTitle, processId, host) => `
  ...
  You are encouraged to follow the updates, register to attend meetings and join the discussion at the process page: https://${host}/process/${processId}.\n\n
...
const getInviteToPrivateProcessText = (firstName, processTitle, processId, processAdmin, host) => `
  ...
  If you wish to accept this invite and join the process, simply go to the process page and click the "Join" button: https://${host}/process/${processId}.\n\n
