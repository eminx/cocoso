  ...
  <div>
    <div>
      ...
      <p>
        ...
        ${values.name}, and can sign yourself up (RSVP) for events with a simple click. Your
      ...
      <p>
        ...
        ${values.name}. These discussions are kept for the duration of the process and will be
        archived, but can be erased if the process wishes.
      </p>
      <p>
        ${values.name} expects all members to keep respectful and supportive language when
        communicating. We want to ensure a friendly and welcoming environment, while encouraging
        critical thinking and constructive dialogue. Members who go against these simple rules run the
        risk of having their membership removed.
      </p>
      <p>
        Your personal information will never be shared with any external party. You can easily delete
        your membership anytime you want.
      </p>
      <p>For more information about how your personal information is handled, see our GDPR policy.</p>

      <h2>${values.name}'s data policy, GDPR</h2>
      <p>
      ...
      <h2>What data we collect, how we store it, and why</h2>
      <p>
        ${values.name} collects only two pieces of information: a username and an e-mail
        address. Your e-mail address is considered personal information. The name you choose does not
        have to be your legal name, so if you choose to use your legal name you do so at your own
        discretion. This name will be displayed on the website only to other members: in the member
        list of processes you have joined; when sending discussion messages; and in the RSVP list when
        attending events (this latter visible only to staff).
      </p>
      <p>
        We use your e-mail address to send you notifications. ${values.name} collects this
      ...
      <h2>Data storage</h2>
      <p>
        ${values.name} uses cookies in your web browser for the sole purpose of storing your
        password. Your password is encrypted in our database, so there is no way we can access or read
        it. Your connection to ${values.name} is also encrypted using SSL (HTTPS).
      </p>
      <p>
      ...
      <h2>Data sharing</h2>
      <p>
        We will never share or leave any of your personal information with any third party. We do not
        use any form of tracking, either on our own servers or via third parties.
      </p>

      <h2>Access outside the EU/EES</h2>
      <p>
      ...
      <h2>Requesting information about your personal information</h2>
      <p>
        You can contact ${values.name} via e-mail to request anything about your personal
        information—what we store, how it is used, and if you want to change or remove it.
      </p>

      <h2>Account deletion</h2>
      <p>
        You can delete your account at any time, which will delete all personal information associated
        with it. This can be accomplished by the “delete account” button on your user page, or by
        e-mailing us.
      </p>

      <h2>How long is information stored?</h2>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            Agreement) refers to Emin Durak, Gokbel mah. Bozegri sk. 8/1 Ortaca, Mugla.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to ${values.name}, accessible from
            <a href="${values.host}" rel="external nofollow noopener" target="_blank">${values.host}</a>
          </p>
        </li>
        <li>
          <p>
