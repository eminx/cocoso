...
This is a custom version of force-ssl package.
Instead of using 'ROOT_URL' with 'Meteor.absoluteUrl()', 
this package gets the requested host address from 
'httpServer / listener / request / headers'.
