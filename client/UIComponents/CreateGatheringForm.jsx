        ...
        <Form onSubmit={this.handleSubmit}>
          ...
          <FormItem {...formItemLayout} label="Long description">
            {getFieldDecorator('longDescription', {
              ...
              <TextArea
                placeholder="Enter a detailed description of your Stream"
                autosize
              />
            )}
          </FormItem>
          ...
          <FormItem {...formItemLayout} label="Duration (hours)">
            {getFieldDecorator('duration', configDuration)(<InputNumber />)}
          </FormItem>
          ...
          >
            ...
            <Button onClick={() => this.setState({ addPlaceModal: true })}>
              Add place
            </Button>
          </div>

          <FormItem {...formItemLayout} label="Select Room">
            {getFieldDecorator('room', {
              rules: [
                {
                  required: true,
                  message:
                    'Please enter where in the UB you are hosting your event'
                }
              ]
            })(
              <Select placeholder="Select place in the venue...">
                {places
                  ? places.map((part, i) => (
          ...
          <FormItem {...formItemLayout} label="Require RSVP?">
